...
function movePageDown(posNum, group)
{ 
	var pos1 = parseInt(posNum);
	var pos2 = parseInt(posNum) + 1;
	var id1 = document.getElementById("page_id" + pos1).value;
	var page1 = document.getElementById("page_num" + pos1).value;
	
	if(document.getElementById("page_id" + pos2) != null)
	{
		var id2 = document.getElementById("page_id" + pos2).value;
		var page2 = document.getElementById("page_num" + pos2).value;
		window.location.href = URL + "groups.php?action=move&group=" + group + "&id1=" + id1 + "&id2=" + id2 + "&page1=" + page1 + "&page2=" + page2;
	}
}

function movePageUp(posNum, group, title)
{
	var pos1 = parseInt(posNum);
	var pos2 = parseInt(posNum) - 1;
	var id1 = document.getElementById("page_id" + pos1).value;
